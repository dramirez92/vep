...
define("customer","model/CUSTOMER.php");
define("owner_or_agent","model/OWNER_OR_AGENT.php");
define("country","model/COUNTRY.php");
define("local","model/LOCAL.php");
define("meeting","model/MEETING.php");
